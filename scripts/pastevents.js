      ...
      card += `
        <div class="card" id="${data.events[i].category.replace(" ","-").toLocaleLowerCase()}" style="width: 18rem;">
          ...
          <div class="card-body">
            ...
            <h6 class="category-title" style="display:none;">${data.events[i].category.replace(" ","-").toLocaleLowerCase()}</h6>
            <p class="card-text" style="overflow:auto; height:8vh">${data.events[i].description}</p>
          </div>
...
let arrayCategories = data.events.map(ev => ev.category)
